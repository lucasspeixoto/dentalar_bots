...
from core.load_contacts import *
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.send_whatsapp_messages_button.clicked.connect(lambda: threading.Thread(target=Contacts.send_whatsapp_messages(self), daemon=True).start())
            #-- Check Load All Contacts Radio Button
        self.ui.send_to_all_contacts_radio_button.toggled.connect(lambda: threading.Thread(target=Contacts.toggle_all_contacts(self), daemon=True).start())
        #############################################################

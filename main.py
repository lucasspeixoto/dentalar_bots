...
from PySide2.QtCore import (Qt, QRunnable, Slot, QThreadPool, QCoreApplication, QPropertyAnimation, QDate, QDateTime,
                            QMetaObject, QObject, QPoint, QRect, QSize, QTime, QUrl, QEvent)
...
class MainWindow(QMainWindow):
    ...
    def send_whatsapp_messages_pointer(
        self): Contacts.send_whatsapp_messages(self)
